...
const faqs = [
  {
    question: "Do you help with map sanction and approvals in Indore?",
    answer:
      "Yes, RD Kunhare provides map sanction and IMC building plan approval services in Indore.",
  },
  {
    question: "Can you assist with construction permission from authorities?",
    answer:
      "Yes, we assist with construction permission and documentation required for residential and commercial projects.",
  },
];
